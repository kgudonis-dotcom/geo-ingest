...
| `build_infra.py` | OSM (Geofabrik) ceļi un ūdensteces pa pagastiem (pagasta aptvērums + 2 km). #39: `watera[].geom` MultiPolygon.coordinates formātā (visi bbox-apgriešanas fragmenti + caurumi, ne tikai lielākais) | `pagasti/` | `infra/PPPP.json.gz` |
