...
Atjaunots: 2026-09-02 (#46 bonitāte no VMD un cirtmets pēc bonitātes; #45 nogabalu ticamības pārbaude; #44 objekts = NĪ ar vairākām ZV). Šis fails ir vienīgā patiesība par to, kas norunāts, kas gatavs un kas nav. Glabājas repo `kgudonis-dotcom/geo-ingest` (STATUSS.md) un tiek atjaunots pēc katra darba.
