...
Atjaunots: 2026-09-03 (#39/#22 CI un infra pārbūve, #21 izvešanas ceļi 1. posms, #44 NĪ vairākas ZV UI: modālis, arhivēšanas apstiprinājums). Šis fails ir vienīgā patiesība par to, kas norunāts, kas gatavs un kas nav. Glabājas repo `kgudonis-dotcom/geo-ingest` (STATUSS.md) un tiek atjaunots pēc katra darba.
